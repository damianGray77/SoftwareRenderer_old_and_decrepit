...
static const Vertex3c verticesc[] = {
	{  0.0f, 0.00f, 0.00f, 0xff000000, },
	{  1.0f, 0.00f, 0.00f, 0xff000000, },
	{  1.0f, 0.50f, 0.50f, 0xffff0000, },
	{  1.0f, 0.50f,-0.50f, 0xffffff00, },
	{  1.0f,-0.50f, 0.50f, 0xff00ff00, },
	{  1.0f,-0.50f,-0.50f, 0xff00ffff, },
	{  1.0f, 0.70f, 0.00f, 0xff0000ff, },
	{  1.0f,-0.70f, 0.00f, 0xffff00ff, },
	{  1.0f, 0.00f, 0.70f, 0xffff0000, },
	{  1.0f, 0.00f,-0.70f, 0xffffff00, },
	{  1.0f, 0.25f,-0.65f, 0xff00ffff, },
	{  1.0f,-0.25f,-0.65f, 0xff0000ff, },
	{  1.0f, 0.25f, 0.65f, 0xffff00ff, },
	{  1.0f,-0.25f, 0.65f, 0xffff0000, },
	{  1.0f,-0.65f, 0.25f, 0xffffff00, },
	{  1.0f,-0.65f,-0.25f, 0xff00ff00, },
	{  1.0f, 0.65f, 0.25f, 0xff00ffff, },
	{  1.0f, 0.65f,-0.25f, 0xff0000ff, },

	{ -1.0f, 0.00f, 0.00f, 0xffffffff, },
	{ -1.0f, 0.50f, 0.50f, 0xffff00ff, },
	{ -1.0f, 0.50f,-0.50f, 0xffff0000, },
	{ -1.0f,-0.50f, 0.50f, 0xffffff00, },
	{ -1.0f,-0.50f,-0.50f, 0xff00ff00, },
	{ -1.0f, 0.70f, 0.00f, 0xff00ffff, },
	{ -1.0f,-0.70f, 0.00f, 0xff0000ff, },
	{ -1.0f, 0.00f, 0.70f, 0xffff00ff, },
	{ -1.0f, 0.00f,-0.70f, 0xffff0000, },
	{ -1.0f, 0.25f,-0.65f, 0xffffff00, },
	{ -1.0f,-0.25f,-0.65f, 0xff00ff00, },
	{ -1.0f, 0.25f, 0.65f, 0xff00ffff, },
	{ -1.0f,-0.25f, 0.65f, 0xff0000ff, },
	{ -1.0f,-0.65f, 0.25f, 0xffff00ff, },
	{ -1.0f,-0.65f,-0.25f, 0xffff0000, },
	{ -1.0f, 0.65f, 0.25f, 0xffffff00, },
	{ -1.0f, 0.65f,-0.25f, 0xff00ff00, },
};
